...
import com.bazl.dna.mix.compare.algorithm.constants.AlgorithmConstants;
...
import com.bazl.dna.mix.compare.algorithm.result.MixStrCompareResultAllele;
import com.bazl.dna.mix.compare.utils.ListStringUtils;
...
public class MixStrComparator extends CommComparator {
    ...
    */
    ...
    public static MixStrCompareResult compareToSingleStr(String mixGeneInfoDetail,
        ...
        List<DnaGeneInfoDetail> targetGeneInfoDetailList = JSONArray.parseArray(GeneTransFormUtils.geneFormatLists(targetGeneInfoDetail), DnaGeneInfoDetail.class);

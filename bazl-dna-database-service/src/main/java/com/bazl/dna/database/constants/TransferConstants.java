...
public class TransferConstants implements Serializable {
     ...
     * 生成文件失败
     */
    public static final String TRANSFER_STATUS_GENERATE_ERROR = "-1";
     ...
     * 生成文件成功
     */
    public static final String TRANSFER_STATUS_GENERATE_SUCCEED = "1";
    ...
    public static final String GENE_LADDER = "1";
    public static final String GENE_YANG = "2";
    public static final String GENE_YIN = "3";
    //混合类型：国家库类型为：1

...
import com.bazl.dna.database.algorithm.constants.AlgorithmConstants;
import com.bazl.dna.database.algorithm.params.CommCompareParams;
import com.bazl.dna.database.algorithm.result.MixStrCompareResult;
import com.bazl.dna.database.algorithm.result.MixStrCompareResultAllele;
...
public class MixStrComparator extends CommComparator {
    ...
    public static MixStrCompareResult compareToSingleStr(String mixGeneInfoDetail,
                                                         ...
                                                         String targetGeneInfoDetail, CommCompareParams compareParams){
        ...
        System.out.println(targetGeneInfoDetail);
    ...
    private static MixStrCompareResult compareToSingleStr(List<DnaGeneInfoDetail> mixGeneInfoDetailList,
                                                         ...
                                                         List<DnaGeneInfoDetail> targetGeneInfoDetailList,
                                                          CommCompareParams compareParams){
        try {
            ...
            if(result != null
                ...
                */
                ...
                for(DnaGeneInfoDetail targetGene : targetGeneInfoDetailList){
                    ...
                    List<String> possibilityAlleleList = null;

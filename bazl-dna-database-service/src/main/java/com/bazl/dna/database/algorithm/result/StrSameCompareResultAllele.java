 ...
 */
public class StrSameCompareResultAllele implements Serializable {
    ...
    public Double getLikelihoodRate() {
        return likelihoodRate;
    }

    public void setLikelihoodRate(Double likelihoodRate) {
        this.likelihoodRate = likelihoodRate;
    }
}

      ...
      <Col span="20" class="part">
        <Row class="nav">
          <Col span="24" v-show="status_0">
            ...
            <Icon type="md-arrow-forward" />
            <router-link to="/quickmanage/quickStrResult">比中结果</router-link>
            <Icon type="md-arrow-forward" />
            <router-link to="/quickmanage/quickStrDetail"
              >比中结果详情</router-link
            >
          </Col>
          <Col span="24" v-show="status_1">
            ...
            <router-link to="/quickmanage/STR">混合STR比对</router-link>
            <Icon type="md-arrow-forward" />
            <router-link to="/quickmanage/StrRecord">比中记录查询</router-link>
            <Icon type="md-arrow-forward" />
            <router-link to="/quickmanage/StrRecordView"
              >比中结果列表</router-link
            >
            <Icon type="md-arrow-forward" />
            <router-link to="/quickmanage/quickStrDetail"
...
export default {
      ...
      tableCol: [
        {
          ...
          // render: (h, params) => {
          //   return h('span', {
          //     class: params.row.flag === '0' ? 'red-font' : ''
          //   }, params.row.name)
          // }
        },
        {
  ...
  mounted() {
    const info = sessionStorage.getItem('quickStrDetail')
    if (info !== 'undefined') {
  ...
  watch: {
    result: {
      handler: function(newVal, oldVal) {
        ...
        this.visNo = newVal.geneMap.totalLR
      },
      deep: true,
      immediate: true
    }

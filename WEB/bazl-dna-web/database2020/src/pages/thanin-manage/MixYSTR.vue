      ...
      <Col span="20" class="part">
        <Row class="nav">
          <Col span="24">
            ...
            <router-link to="/thanin/ystr">Y-STR比中</router-link>
          </Col>
        </Row>
        <div class="form-part">
          <div class="title">
            ...
            <Col span="8" class="item-col">
              ...
              <span class="item-group">
                <Cascader
                  ...
                  v-model="searchForm.clientOrgList"
        ...
        <div class="result-part">
          <Row class="title">
            <Col span="12" class="left-title">
              <span>比中结果列表</span>
              <button class="btn btn-blue-bg" @click="handExportBzres">批量导出确认比中结果Excel</button>
                ...
                <Col span="11" class="center-title">
                  <span>
                    ...
                    <span class="blue-font">{{
                      item.groupMatchType === '1'
                        ? '人员-物证比中'
                        : item.groupMatchType === '2'
                        ? '物证-物证比中'
                        : '人员比中'
                    }}</span>
                  </span>
          ...
          <div class="page">
            <span>
              当前第{{ searchForm.pageIndex }}页/共{{ pageCount }}页/共{{
                allRecordCount
              }}条信息
            </span>
            <Page
  ...
  methods: {
    ...
    handExportBzres() {
      if (this.checkedGroup.length > 0) {
        ...
        const id_str = this.checkedList.join(',')
        console.log(id_str)
        // eslint-disable-next-line camelcase
        location.href = '/api/database/export/ystr/result?ids=' + id_str
      } else {
        this.$Modal.error({
          title: '抱歉',
          content: '请先选择要操作的组别！'
    ...
    getStrResultQuery() {
      ...
      this.$axios
        .post('/database/match/ystr/resultQuery', this.searchForm)
        .then(res => {

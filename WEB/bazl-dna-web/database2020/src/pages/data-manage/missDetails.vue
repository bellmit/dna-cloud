      ...
      <Col span="20" class="part">
        <Row class="nav">
          <Col span="24">
            ...
            <Icon type="md-arrow-forward" />
            <router-link to="/datamanage/missDetails">失踪人员详情</router-link>
          </Col>
        </Row>
...
export default {
  ...
  methods: {
    ...
    getInitResult() {
      ...
      this.$axios.get('/database/casemissing/get/' + this.id).then(res => {
        console.log(res)
    ...
    viewDetails(id, type) {
      ...
      this.$axios.get('/database/casemissing/getInfo/' + id).then(res => {
        console.log(res)

      ...
      <Col span="20" class="part">
        <Row class="nav">
          <Col span="24">
            ...
            <router-link to="/geneticmanage/YSTR">Y-STR基因座管理</router-link>
          </Col>
        </Row>
        <div class="form-part">
          <div class="title">
...
export default {
  ...
  methods: {
    ...
    handInitData() {
      this.$axios
        .post('database/locus/listAllYstrLocus', this.searchInfo)
        .then(res => {
          console.log(res)
          if (res.code === 1) {
            this.tableData = res.result.YstrDnaLoucsInfoList
            this.allRecordCount = res.result.pageInfo.allRecordCount
            // this.searchInfo.pageIndex = res.result.pageInfo.curPage
    ...
    handSave() {
      ...
      this.$axios
        .post('database/locus/updateYstrGeneInfo', this.saveLsit)
        .then(res => {
          // console.log(res)

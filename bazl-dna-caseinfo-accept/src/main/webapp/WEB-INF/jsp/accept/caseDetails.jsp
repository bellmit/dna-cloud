                    ...
                    <div class="panel-body">
                        <div class="col-md-4 small-left">
                            <div class="form-group">
                                <label>受理单位</label>
                                <div class="select">
                                    <select id="acceptOrgId" name="acceptOrgId" class="form-control clientSelect">
                                            class="form-control">
                                        <option value="" selected>全部</option>
                                        <c:forEach items="${acceptOrgList}" var="list" varStatus="cs">
                                            <option value="${list.orgId}"
                                                    <c:if test="${list.orgId eq consignatioInfo.acceptOrgId}">selected</c:if>>${list.orgName}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </div>
                        ...
                        <div class="col-md-4 small-left">
                            <div class="form-group">
                                <label>受理人:</label>
                                <div class="select">
                                    <select id="acceptorId" name="acceptorId" class="form-control clientSelect">
                                        ...
                                        <c:forEach items="${amPersonalInfoVoList}" var="list" varStatus="cs">
                                            <option value="${list.entity.personalId}"
                                                    <c:if test="${list.entity.personalId eq consignatioInfo.acceptorId}">selected</c:if>>${list.entity.fullName}</option>
                                        </c:forEach>
                                    </select>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="select">
                                    <input type="text" name="acceptDatetime" id="acceptDatetime"
                                           value="<fmt:formatDate value='${consignatioInfo.acceptDatetime}' pattern='yyyy-MM-dd '/>"
                                           class="form-control form_datetime" placeholder="请输入受理时间">
                                </div>
                            </div>
                        </div>
                    </div>
...
//             var signatureSrc = signature.jSignature("getData", "image")[1]
        ...
        $(document).on("scroll", function(){
            if ($(document).scrollTop() >= 112) {
                $(".zind").css({"z-index":"1","background":"white","box-shadow": "0px 0px 10px 5px #ebebeb"})
                $(".caseSchedule ").css({
                    "position":"fixed",
                    "margin-top":"68px"
                })
                ...
                $(".zind").css({"z-index":"-1","background":"none","box-shadow": "0px 0px 0px 0px"})
            }
        });
        ...
        function getAcceptInfo(){
            var acceptInfo = {};
            acceptInfo.acceptOrgId = $("#acceptOrgId").val();//受理机构编号
            acceptInfo.acceptorId = $("#acceptorId").val();//受理人编号
            acceptInfo.acceptDatetime = $("#acceptDatetime").val().trim();//受理时间
            return acceptInfo;
        }

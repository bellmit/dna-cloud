    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form id="consignationForm" action="<%=path %>/center/waitAccept" class="form-horizontal tasi-form"
                      method="post">
                    <div class="row">
                        ...
                        <div class="col-md-4 seachInputBox">
                            <div class="form-group seachButtonBox">
                                ...
                                <input type="button" name="resetBtn" id="resetFrom" class="btn btn-blue-border" value="重置" />
                            </div>
                        </div>
                    </div>
                </form>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <table class="table table-hover table-bordered bigTable">
                    ...
                    <tbody>
                    <c:forEach items="${mainCaseInfoList}" var="list" varStatus="s">
                        <tr>
                            <td>${s.index+1}</td>
...
<div class="modal fade popBox bigBox" id="confirmAccept" tabindex="-1" role="dialog" style="padding-top: 10%;"
                        ...
                        <div class="form-group" style="padding-left: 30%;opacity:0.5;color:black;">
                            <div>
                                <h2 style="font-size: 20px;font-weight:bold;color: black">
                                    当前受理人为：${loaUserInfo.amPersonalInfo.fullName}</h2>
                            </div>
                        </div>
                    </div>
                </div>
...
<script>
    $(function () {
        ...
        kkpager.generPageHtml({
            ...
            //链接前部
            hrefFormer: '<%=path%>/center/waitAccept',
            //链接尾部
            //hrefLatter: '.html',

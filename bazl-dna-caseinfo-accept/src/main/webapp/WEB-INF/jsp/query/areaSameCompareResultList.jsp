    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form id="consignationForm" action="<%=path %>/queryCompareResult/queryAreaSameCompareResultList"
                                ...
                                <c:forEach items="${matchResultGroup.sampleList}" var="result" varStatus="c">
                                    <tr>
                                        <td>${c.index+1}
                                            ...
                                            <c:choose>
                                            <c:when test="${result.flag eq '1' &&  result.sampletype eq '3'  || result.sampletype eq '4'  || result.sampletype eq '5'  || result.sampletype eq '6'  || result.sampletype eq '8'  || result.sampletype eq '9'  || result.sampletype eq '10'}">
                                            <span><img src="../img/redIcon.png"></span>
                                            </c:when>
                                            <c:otherwise>
                                                <span><img src="../img/yellowIcon.png" >${result.personCnt}</span>
                                            </c:otherwise>
                                            </c:choose>

                                            <input type="hidden" name="sampletype"  value="${result.sampletype}">
                                            <input type="hidden" name="flag" value="${result.flag}">
                                            <input type="hidden" name="personCnt" value="${result.personCnt}">
                                            <%--<span><img src="../img/redIcon.png"></span>--%>
                                        </td>
...
<script>
    $(function () {
        ...
        $("button[name='viewDatail']").on("click",function(){
            ...
            location.href = "<%=path%>/queryCompareResult/queryAreaSameCompareResultDetail?sampleNo=" +
        ...
        kkpager.generPageHtml({
            ...
            //链接前部
            hrefFormer: '<%=path%>/queryCompareResult/queryAreaSameCompareResultList',
            //链接尾部
            //hrefLatter: '.html',
        ...
        $("button[name='reset']").on("click", function () {
            location.href = "<%=path%>/queryCompareResult/queryAreaSameCompareResultList";
        })

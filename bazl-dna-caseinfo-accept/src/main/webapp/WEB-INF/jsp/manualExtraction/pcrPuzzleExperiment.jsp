...
<script>
    $(function () {
                ...
                success:function(data){
                    if(data.success || data.success == true || data.success == "true") {
                        $.ajax({
                            ...
                            success:function(data){
                                if(data.success || data.success == true || data.success == "true") {
                                    location.href = "<%=path%>/handwork/pcrExperiment?pcrId=" + data.pcrId;
                                }
                            }
                        });
                    } else {
        ...
        function GetLabPcrInfo() {
            var labPcrInfo = {};

            labPcrInfo.boardNo = $("#boardNo").val();
            labPcrInfo.pcrStage = "0";

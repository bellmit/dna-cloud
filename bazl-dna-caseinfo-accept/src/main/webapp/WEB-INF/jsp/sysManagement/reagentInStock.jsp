    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-heading blue">
                <div>查询条件</div>
                <input type="hidden" name="actionName" id="actionName" value="<%=path%>/center/reagentInStock">
            </div>
            <div class="panel-body">
                <form id="consignationForm" action="<%=path%>/center/reagentInStock"
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 seachInputBox">
                            <div class="form-group">
                                <label>入库名称</label>
                                <input type="text" class="form-control" placeholder="请输入入库名称" name="reagentName"
                ...
                <table class="table table-hover table-bordered bigTable">
                    ...
                    <c:forEach items="${reagentOutgoInfoList}" var="outgolist" varStatus="s">
                        <tr>
                            ...
                            <td>${outgolist.batchNumber}
                                <input type="hidden" name="batchNumber"
                                       value="${outgolist.batchNumber}"></td>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    <button class="btn btn-blue btn-lang" id="addtBtn" name="reagentInStockBtn">保存</button>
...
<script>
    $(function () {
        ...
        function saveForm(){
            $.ajax({
                url: "<%=path%>/center/addReagentInStock",
                type: "post",
...
//                        alert("保存成功");
                        location.href = "<%=path%>/center/reagentInStock";
                    } else {
                        alert("保存失败！");
                    }
                },

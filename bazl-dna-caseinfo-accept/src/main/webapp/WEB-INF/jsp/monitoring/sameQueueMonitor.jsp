    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form id="stateStorageForm" action="<%=path%>/center/SameQueueMonitor" class="form-horizontal tasi-form"
                      method="post">
                    <div class="row">
...
<script>
    $(function () {
        ...
        kkpager.generPageHtml({
            ...
            //链接前部
            hrefFormer: '<%=path%>/center/SameQueueMonitor',
            //链接尾部
            //hrefLatter: '.html',
        ...
        $("button[name='reset']").on("click", function () {
            ...
            location.href = "<%=path%>/center/SameQueueMonitor";
        })

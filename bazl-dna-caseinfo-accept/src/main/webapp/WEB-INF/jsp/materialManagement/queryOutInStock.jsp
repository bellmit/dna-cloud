    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form id="consignationForm" action="<%=path%>/supplies/consumeOutInStock"
                    ...
                    <c:forEach items="${OutgoInfoList}" var="infolist" varStatus="s">
                        <tr>
                            ...
                            <td><c:forEach items="${suppliesInfoList}" var="supplieslist">
                                <c:if test="${supplieslist.id eq infolist.suppliesId}">${supplieslist.suppliesName}</c:if>
                            </c:forEach>
                            ...
                            <td>
                                <c:if test="${infolist.recordType eq '0'}">入库</c:if>

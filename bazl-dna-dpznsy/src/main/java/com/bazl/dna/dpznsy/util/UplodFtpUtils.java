...
public class UplodFtpUtils {
    ...
    //上传文件
    public static String uploadFtpFileDoc(String ftpIp, String ftpPort, String ftpUser, String ftpPassword, String ftpPersonImg, String fileName) {
        //创建客户端对象
        FTPClient ftp = new FTPClient();
        InputStream local = null;
        String path = "";
...
//            ftp.storeFile(file.getName(), local);
    ...
    public static String httpLinkNew(HttpServletRequest request, String ftpIp, String page, String ftpUser, String ftpPassword, String ftpFilePath, String fileName) {
        ...
        try {
            ...
            //设置连接输出流为true,默认false (post 请求是以流的方式隐式的传递参数)            uc.setDoOutput(true);
            // post请求缓存设为false

...
public class QuickCompareConstants extends PublicConstants {
	...
	public static final String QUEUE_KEY_QUICK_STR_SAVE_MATCH_RESULT = QUEUE_NAME + "StrSaveMatchResult";
	...
	public static final String QUEUE_KEY_QUICK_YSTR_SAVE_MATCH_RESULT = QUEUE_NAME + "YstrSaveMatchResult";
	...
	public static final String QUEUE_KEY_QUICK_MIX_SAVE_MATCH_RESULT = QUEUE_NAME + "MixSaveMatchResult";
	...
	public static final String QUEUE_KEY_QUICK_RELATIVE_THREE_CONJOINED_SAVE_MATCH_RESULT = QUEUE_NAME + "ThreeConjoinedSaveMatchResult";
	...
	public static final String QUEUE_KEY_QUICK_RELATIVE_SINGLE_CONJOINED_SAVE_MATCH_RESULT = QUEUE_NAME + "SingleConjoinedSaveMatchResult";

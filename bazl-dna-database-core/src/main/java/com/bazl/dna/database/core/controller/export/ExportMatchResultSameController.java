...
@RestController
@RequestMapping("/export/same")
public class ExportMatchResultSameController extends BaseController {
	...
	public ResponseEntity<byte[]> matchResultSame(String ids) {
		try {
			...
			for (String id : idsArray) {
				MatchResultSame entity = matchResultService.getById(Integer.parseInt(id));
			...
			String fileName = "Same_" + new Date().getTime() +".xls";

 ...
 */
@RestController
@RequestMapping("/converter/criminal/person")
public class CriminalPersonInfoConverter extends BaseController {

	@Autowired
	private CriminalPersonInfoService service;
	
	/**
	 * 保存
	 */
	@PostMapping("save")
	public ResponseData save(@RequestBody CriminalPersonInfo info) {
		if (info == null) {

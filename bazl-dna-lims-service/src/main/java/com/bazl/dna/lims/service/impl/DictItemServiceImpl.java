...
import com.bazl.dna.lims.dao.DictItemMapper;
...
//        redisTemplate.boundHashOps("dictItem").put(record.getDictTypeCode(),aa);
    ...
    @Override
    public List<DictItem> selectCaseTypeList() {
        return dictItemMapper.selectCaseTypeList();
    }
    
    @Override
    public DictItem selectDictNameByTypeCode(String dictTypeCode, String dictCode) {
        return dictItemMapper.selectDictNameByTypeCode(dictTypeCode,dictCode);
    }
    
    @Override
    public List<DictItem> selectCaseTypeBydictItemIdList(String dictItemId) {
        return dictItemMapper.selectCaseTypeBydictItemIdList(dictItemId);
    }
    
    @Override
    public List<DictItem> selectListByParentId(String parentId) {
        return dictItemMapper.selectListByParentId(parentId);
    }
}

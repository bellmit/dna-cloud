...
public class LimsPersonInfo implements Serializable {
	...
	/**
	 * @return the coreVictimStats
	 */
	public String getCoreVictimStats() {
		return coreVictimStats;
	}

	/**
	 * @param coreVictimStats the coreVictimStats to set
	 */
	public void setCoreVictimStats(String coreVictimStats) {
		this.coreVictimStats = coreVictimStats;
	}
	...
	/**
	 * @param samplePackingName the samplePackingName to set
	 */

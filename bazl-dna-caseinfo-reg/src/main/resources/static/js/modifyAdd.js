...
$(".addAuthenticator").click(function () {
    ...
    if (form.data('bootstrapValidator').isValid()) {
        ...
        var authenticatorBox = $("#addAuthenticatorBig").find(".modal-content").eq(0),
            ...
            kinship = authenticatorBox.find("select[name='relationType']").val(),
            ...
            inlineCheckbox1 = authenticatorBox.find("input:checkbox[name='inlineCheckbox1']:checked").val(),
        ...
        if (kinship == null) {
            ...
            kinshipName = authenticatorBox.find("select[name='relationType']").find("option:selected").text()
        }
        if (noIdCard !== "") {
...
//                    personTr += '<td><div class="showPhoto"></div></td>'
            ...
            personTr += '<input type="hidden" name="inlineCheckbox1" value="' + inlineCheckbox1 + '"/>'
            personTr += '</td>'
            personTr += '</tr>'
        ...
        if (authenticatorBox.find("input[name='moveCheckbox']").is(':checked')) {
            ...
            personSampleTr += '<td>' + personTypeName + '<input type="hidden" name="personTypeName" value="' + personTypeName + '"/></td>'
            personSampleTr += '<td>' + personName + '<input type="hidden" name="personName" value="' + personName + '"/></td>'
            personSampleTr += '<td>' + sexName + '<input type="hidden" name="sexName" value="' + sexName + '"/></td>'
            personSampleTr += '<td>' + nowId + '<input type="hidden" name="idCard" value="' + idCard + '"/><input type="hidden" name="noIdCard" value="' + noIdCard + '"/></td>'
            personSampleTr += '<td>' + kinshipName + '<input type="hidden" name="kinshipName" value="' + kinshipName + '"/></td>'
            if (inlineCheckbox1 == 'on'){
                personSampleTr += '<td><div class="victimSelect"><select class="form-control" name="coreVictimStats" id="coreVictimStats" required disabled><option value="1" selected >是</option><option value="0">否</option></select></div></td>'
            }else {
                personSampleTr += '<td><div class="victimSelect"><select class="form-control" name="coreVictimStats" id="coreVictimStats" required disabled><option value="1">是</option><option value="0" selected>否</option></select></div></td>'
            }
            ...
            personSampleTr += '<input type="hidden" name="personType" value="' + personType + '"/>'
            personSampleTr += '<input type="hidden" name="year" value="' + year + '"/>'
            personSampleTr += '<input type="hidden" name="inspectionObjective" value="' + inspectionObjective + '"/>'
            personSampleTr += '<input type="hidden" name="kinship" value="' + kinship + '"/>'
            //样本描述
            personSampleTr += '<input type="hidden" name="sampleDescribe" value="' + sampleDescribe + '"/>'
            //住址 身高体重
            personSampleTr += '<input type="hidden" name="personCurrentAddress" value="' + personCurrentAddress + '"/>'
            personSampleTr += '<input type="hidden" name="personHeight" value="' + personHeight + '"/>'
            personSampleTr += '<input type="hidden" name="personWeight" value="' + personWeight + '"/>'
            ...
            personSampleTr += '<input type="hidden" name="sex" value="' + sex + '"/>'
            personSampleTr += '<input type="hidden" name="timeId" value="' + timeId + '"/>'
            //inlineCheckbox1
            personSampleTr += '<input type="hidden" name="inlineCheckbox1" value="' + inlineCheckbox1 + '"/>'
            personSampleTr += '</td>'
            personSampleTr += '</tr>'
            $("#personSampleTbody").append(personSampleTr)
            /*$("#personSampleTbody").children().eq(sampleLength - 1).find("td").eq(6).append(extractMethodBox)
            $("#personSampleTbody").children().eq(sampleLength - 1).find("t d").eq(6).append(sampleCarrierBox)*/
        }
        $('#addAuthenticatorBig').modal('hide')
    }
})
...
$("#personSampleTbody").on("click", ".edit", function () {
    ...
    var authenticatorTr = $(this).parents("tr"),
        ...
        authenticatorBox2 = $("#addAuthenticatorBig").find(".modal-content").eq(0),
        personName = authenticatorTr.find("input[name='personName']").val(),
        idCard = authenticatorTr.find("input[name='idCard']").val(),
        year = authenticatorTr.find("input[name='year']").val(),
        personType = authenticatorTr.find("input[name='personType']").val(),
        ...
        inlineCheckbox1 = authenticatorTr.find("input[name='inlineCheckbox1']").val(),
    ...
    authenticatorBox.find("select[name='sampleType']").find("option[value='" + sampleType + "']").prop("selected", true)
    ...
    authenticatorBox2.find("input[name='personName']").val(personName)
    authenticatorBox2.find("input[name='idCard']").val(idCard)
    authenticatorBox2.find("select[name='personType']").find("option[value='" + personType + "']").prop("selected", true)
    authenticatorBox2.find("select[name='relationType']").find("option[value='" + kinship + "']").prop("selected", true)
    authenticatorBox2.find("input[name='year']").val(year)
    if (sampleBase) {
...
$(".addMaterialEvidencer").click(function () {
    ...
    $("#materialEvidencerlSampleBox").find("select[name='coreTakenStats']").val("")
...
$("#materialEvidencerTbody").on("click", ".edit", function () {
    var sampleTypeName = $(this).parents("tr").find('input[name="sampleTypeName"]').val(),
        ...
        coreTakenStats = $(this).parents("tr").find('select[name="coreTakenStats"]').val(),
    ...
    $("#materialEvidencerlSampleBox").find('select[name="extractMethod"]').val(extractMethod)
    $("#materialEvidencerlSampleBox").find('select[name="coreTakenStats"]').val(coreTakenStats)
    $("#materialEvidencerlSampleBox").find('select[name="sampleCarrier"]').val(sampleCarrier)
...
$('.addMaterialEvidencerlSample').click(function () {
    ...
    var sampleTypeName = $("#materialEvidencerlSampleBox").find('select[name="sampleType"]').children("option:selected").html(),
        ...
        coreTakenStats = $("#materialEvidencerlSampleBox").find('select[name="coreTakenStats"]').val(),
    ...
    if (form.data('bootstrapValidator').isValid()) {
        ...
        if (index != "") {
            ...
            tr.find('input[name="sampleCarrier"]').val(sampleCarrier)
            if (coreTakenStats ==1){
                tr.find('select[name="coreTakenStats"]').val(1)
            }else {
                tr.find('select[name="coreTakenStats"]').val(0)
            }
            tr.children("td").each(function (i) {
                if (tr.children("td").length - 1 !== i) {
                    var tdInput = $(this).children("input").clone()
            ...
            if (coreTakenStats == 1){
                newTr +='<td><div class="coreTakenSelect" width="100%"><select name="coreTakenStats" id="coreTakenStats" name="coreTakenStats"  class="form-control" required><option value="0">否</option><option selected value="1">是</option></select></div></td>'
            }else{
                newTr +='<td><div class="coreTakenSelect" width="100%"><select name="coreTakenStats" id="coreTakenStats" name="coreTakenStats"  class="form-control" required><option selected value="0">否</option><option  value="1">是</option></select></div></td>'
            }
            //newTr += '<td><div class="select" style="width:100%"><select name="coreTakenStats" class="coreTakenSelect form-control" value=""><option value=" " selected></option><option value="0">否</option><option value="1">是</option></select></div></td>'
            /*newTr += '<td>' + sampleTypeName + '<input type="hidden" name="sampleTypeName" value="' + sampleTypeName + '"></td>'
            newTr += '<td>' + sampleName + '<input type="hidden" name="sampleName" value="' + sampleName + '"></td>'
            newTr += '<td>' + sampleName + '<input type="hidden" name="sampleName" value="' + sampleName + '"></td>'
            newTr += '<td>' + evidenceNo + '<input type="hidden" name="evidenceNo" value="' + evidenceNo + '"></td>'
            ...
            newTr += '<input type="hidden" name="sampleDescribe" value="' + sampleDescribe + '">'
            newTr += '<input type="hidden" name="coreTakenStats" value="' + coreTakenStats + '">'
            newTr += '</td>'
            newTr += '</tr>'
...
function getCaseInfoDna() {
    var caseInfoDna = {};
    //一级案件性质
    var caseProperty = $("option:selected", "#caseProperty").val();
    // 二级案件性质
    var casePropertyLv2 = $("option:selected", "#casePropertyLv2").val();
    //console.log(casePropertyLv2);
    //如果二级不为空 将二级赋值给caseProperty
    if (casePropertyLv2!=""){
        caseProperty = casePropertyLv2;
    }
    ...
    caseInfoDna.caseProperty = caseProperty;//案发性质

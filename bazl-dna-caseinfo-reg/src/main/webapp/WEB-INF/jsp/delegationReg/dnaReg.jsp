        ...
        <div class="record">
            ...
            <div class="rowst">
                <div class="form-group lay col-md-4">
                    <label>现场勘验编号</label>
                    <input type="text" id="contentValuehid" name="caseXkNo" class="form-control" value="${xkNo}">
                </div>
                <div class="form-group lay col-md-4">
                    <label>案件三版本编号</label>
                    <input type="text" class="form-control" id="exampleInputPassword12" placeholder="请输入案件三版本编号"
                           value="${limsCaseInfo.xkAno}">
                </div>
                <div class="form-group lay col-md-4">
                    <label for="exampleInputPassword13">现场系统委托编号</label>
                    <input type="text" class="form-control" id="exampleInputPassword13" placeholder="请输入编号"
                           value="${limsCaseInfo.consignationXkNo}">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row Modular">
        <div class="col-md-12">
            <div class="record">
                ...
                <div class="rowsy">
                    <div class="form-group lay col-md-4">
                        <label for="exampleInputPassword13" style="font-weight: 400">案发地点</label>
                    ...
                    <div class="form-group lay col-md-4">
                        <label for="exampleInputPassword13" style="font-weight: 400">备注说明</label>
                    ...
                    <table class="table table-hover table-bordered bigTable">
                        ...
                        <c:forEach items="${limsPersonInfoList}" var="limsPersonInfo" varStatus="s">
                            <tr>
                                ...
                                <td>${limsPersonInfo.relationTypeName}<input type="hidden" name="kinship"
                                                                             value="${limsPersonInfo.relationType}">
                                </td>
                                <td>
                                    <div class="victimSelect">
                                        <select class="form-control" name="coreVictimStats" id="coreVictimStats" required>
                                            <option value="1"
                                                    <c:if test="${'1' eq limsPersonInfo.coreVictimStats}">selected</c:if>>是
                                            </option>
                                            <option value="0"
...
<script>
    $(function () {
        ...
        var url = "<%=path%>/delegate/submitDelegate";

    ...
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-12">
                ...
                <p>保存成功</p>
                <p>可到<a href="javaScript:;" target="ifm" class="searchBtn">案件鉴定列表</a>模块查看</p>
            </div>
            <div class="col-md-12">
                <a href="javascript:;">
            ...
            <div class="col-md-12">
                ...
                <input type="hidden" id="consignmentType" value="${consignmentInfo.consignmentType}">
            </div>
        </div>
    </div>
</div>
...
<script>
    ...
    $(".jixuBTn").click(function(){
        if (consignmentType == "1") {
            location.href="<%=path%>/delegate/fugitivesRegIndex"
        }else {

    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <form id="consignationForm" action="<%=path %>/manage/delegatorManage" class="form-horizontal tasi-form"
                      method="post">
                    <div class="row">
                        ...
                        <div class="col-md-4 seachInputBox">
                            <div class="form-group">
                                <label>警号</label>
                                <input type="text" id="policeNo" name="entity.policeNo"
                                       class="form-control" placeholder="请输入警号">
                            </div>
                        </div>
                        <div class="col-md-4 seachInputBox">
                            <div class="form-group" style="display: flex;align-items: flex-end;margin: 0;">
                                <div style="flex: 1">
                                    <label>联系电话</label>
                                    <input type="text" id="phoneNumber" name="entity.phoneNumber"
                                           class="form-control" placeholder="请输入联系电话">
                                </div>
                                <button class="btn btn-blue" style="height: 30px;position: relative;top: -3px;margin-left: 10px" type="submit" id="addInformant">查询</button>
                            </div>
                        </div>
                    </div>
                </form>
...
<script>
    ...
    kkpager.generPageHtml({
        ...
        //链接前部
        hrefFormer: '<%=path%>/manage/delegatorManage',
        //链接尾部
        //hrefLatter: '.html',

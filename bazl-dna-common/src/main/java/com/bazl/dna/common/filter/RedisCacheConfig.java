...
import com.bazl.dna.util.StringJackson2JsonSerializer;
...
public class RedisCacheConfig extends CachingConfigurerSupport {  
	...
	public RedisTemplate<String, Object> jsonRedisTemplate(RedisConnectionFactory redisConnectionFactory) {
		...
		StringJackson2JsonSerializer<Object> jackson2JsonRedisSerializer = new StringJackson2JsonSerializer<>(Object.class);
		...
		return (target, method, params) -> {
	        ...
	        if (params.length > 0) {
	            ...
	            for (Object object : params) {
	                if (ClassesUtil.isPrimitive(object.getClass())) {

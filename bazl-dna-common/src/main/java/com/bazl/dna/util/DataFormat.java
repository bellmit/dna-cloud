...
public class DataFormat {
    ...
    private static final String[] CHN_UNIT = {"", "十", "百", "千"};          //权位
    private static final String[] CHN_UNIT_SECTION = {"", "万", "亿", "万亿"}; //节权位
    ...
    public static String sectionNumToChn(int section) {
        ...
        while (section > 0) {
            ...
            if (v == 0) {
                ...
                StringBuilder tempStr = new StringBuilder(CHN_NUMBER[v]);//数字v所对应的中文数字

package com.bazl.dna.lims.core.controller.quick;
...
public class QuickCompareController extends BaseController {
    ...
    public ModelAndView same(){
        ...
        modelAndView.setViewName("quickCompar/same");
    ...
    public ModelAndView ystr(){
        ...
        String dnaLabName = orgInfoService.selectLabNameById(operateUser.getOrgId());
        modelAndView.addObject("dnaLabName",dnaLabName);
        modelAndView.setViewName("quickCompar/ystr");
    ...
    public ModelAndView mix(){
        ...
        String dnaLabName = orgInfoService.selectLabNameById(operateUser.getOrgId());
        modelAndView.addObject("dnaLabName",dnaLabName);
        modelAndView.setViewName("quickCompar/mixStr");
    ...
    public ModelAndView kinShip(){
        ...
        String dnaLabName = orgInfoService.selectLabNameById(operateUser.getOrgId());
        modelAndView.addObject("dnaLabName",dnaLabName);
        modelAndView.setViewName("quickCompar/kinShip");

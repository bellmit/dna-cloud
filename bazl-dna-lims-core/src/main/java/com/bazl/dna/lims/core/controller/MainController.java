    ...
    public ModelAndView home(){
        ...
        view.setViewName("home");
            ...
            if("110230000004".equals(operateUser.getOrgId())){
                //查询待送检状态案件数
                int cnt1 = caseInfoService.selectCountByCaseStatus(Constants.CASE_STATUS_PENDING, "110230000000");
                ...
                //查询待领取状态案件数
                int cnt1 = caseInfoService.selectCountByCaseStatus(Constants.CASE_STATUS_PENDING, operateUser.getOrgId());
                view.addObject("cnt1", cnt1);

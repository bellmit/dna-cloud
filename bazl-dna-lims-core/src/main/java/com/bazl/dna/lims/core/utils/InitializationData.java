...
public class InitializationData {
     ...
     * @return
     */
    public CaseSelfCompareParams getInitCaseSelfCompareParam() {
        CaseSelfCompareParams compareParams = new CaseSelfCompareParams();

        compareParams.setSameCompareMatchLimit(limsConfigure.getSameCompareMatchLimit());
        compareParams.setSameCompareDiffLimit(limsConfigure.getSameCompareDiffLimit());

        compareParams.setRelativeCompareMatchLimit(limsConfigure.getRelativeCompareMatchLimit());
        compareParams.setRelativeCompareDiffLimit(limsConfigure.getRelativeCompareDiffLimit());

        compareParams.setMixContributorsCountLimit(limsConfigure.getMixContributorsCountLimit());
        compareParams.setMixCompareMatchLimit(limsConfigure.getMixCompareMatchLimit());
        compareParams.setMixCompareDiffLimit(limsConfigure.getMixCompareDiffLimit());
    ...
    public ModelAndView initDictList() {
        ...
        //档案类别
        dictItem.setDictTypeCode(Constants.FILE_CATEGORY);
        List<DictItem> fileCategoryList = getDictList(dictItem);
        //获取技术任职职称
        dictItem.setDictTypeCode(Constants.TECHNICAL_TITLES);
        List<DictItem> technicalTitlesList = getDictList(dictItem);
        modelAndView.addObject("elutionDefaultList", elutionDefaultList);
        ...
        modelAndView.addObject("fileCategoryList",fileCategoryList);
        modelAndView.addObject("technicalTitlesList",technicalTitlesList);

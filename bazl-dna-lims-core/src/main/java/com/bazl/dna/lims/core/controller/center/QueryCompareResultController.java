...
//                        }
                        ...
                        result2.put(matchSameResultVo.getEntity().getGroupId(), collect);
    ...
    public ModelAndView queryCompareCondition(HttpServletRequest request, String id) {
        ...
        try {
            ...
            if (StringUtils.isNotBlank(matchSameResult.getUpdatePerson())){
                LoaUserInfo loaUserInfo = loaUserInfoService.selectByUserNameOnly(matchSameResult.getUpdatePerson());

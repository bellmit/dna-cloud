package com.bazl.dna.lims.core.common;
...
public class Constants {
    ...
    //菜单顶级节点
    public static final String permission_root_flag = "1";
    //委托人添加委托人职务
    ...
    // 表示匹配成功双亲
    public final static int MATCH_MODE_PARENTS = 1;
    // 表示只匹配父亲
    public final static int MATCH_MODE_FATHER = 2;
    // 表示只匹配母亲
    public final static int MATCH_MODE_MOTHER = 3;
    // 表示单亲都匹配，双亲综合不匹配
    public final static int MATCH_MODE_ONLY_SINGLE = 4;
    ...
    //常规类型：国家库类型为：1
    public final static String GENE_STR = "0";
    //混合类型：国家库类型为：1
    ...
    //案件状态_待送检
    public static final String CASE_STATUS_PENDING = "01";
    //案件状态_在检验
    public static final String CASE_STATUS_EXAMINING = "02";
    //案件状态_已完成
    public static final String CASE_STATUS_FINISHED = "03";
    //案件状态_已退案
    public static final String CASE_STATUS_REFUSED = "04";
    ...
    public static final String APPEND_FLAG_NON = "0";
    public static final String APPEND_FLAG_YES = "1";
    ...
    public static final String FORENSIC_CENTER_SHORT_ORG_ID_BAK = "110230";
    ...
    //卷皮
    public static final String FILE_CATEGORY_01 = "01";
    //目录
    public static final String FILE_CATEGORY_02 = "02";
    //委托书
    public static final String FILE_CATEGORY_03 = "03";
    //聘书
    public static final String FILE_CATEGORY_04 = "04";
    //检材流转记录表
    public static final String FILE_CATEGORY_05 = "05";
    //预实验记录
    public static final String FILE_CATEGORY_06 = "06";
    //受理确认书
    public static final String FILE_CATEGORY_07 = "07";
    //记录表
    public static final String FILE_CATEGORY_08 = "08";
    //图谱
    public static final String FILE_CATEGORY_09 = "09";
    //入库单
    public static final String FILE_CATEGORY_10 = "10";
    //鉴定书
    public static final String FILE_CATEGORY_11 = "11";
    //照片
    public static final String FILE_CATEGORY_12 = "12";

    //重新生成
    public static final String REGENERATE = "regenerate";

    public static final String FLAG_DOWNLOAD = "0";
    public static final String FLAG_PRINT = "1";
}

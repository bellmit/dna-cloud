...
public class LimsSampleInfoDna implements Serializable {
	...
	/**
	 * @param checkStr the checkStr to set
	 */
	public void setCheckStr(boolean checkStr) {
		this.checkStr = checkStr;
	}

	/**
	 * @return the checkYstr
	 */
	public boolean isCheckYstr() {
		return checkYstr;
	}

	/**
	 * @param checkYstr the checkYstr to set
	 */
	public void setCheckYstr(boolean checkYstr) {
		this.checkYstr = checkYstr;
	}
}

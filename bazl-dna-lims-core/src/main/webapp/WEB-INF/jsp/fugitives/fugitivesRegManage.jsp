    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            <div class="panel-body">
                <form id="consignationForm" action="<%=path %>/fugitives/fugitivesRegManage"
                    ...
                    <div class="row">
                        <div class="col-md-4 seachInputBox" style="width: 24.333333%;">
                            <div class="form-group">
                                ...
                                <input type="text" id="personName" name="entity.personName"
                                       value="${query.entity.personName}" class="form-control" placeholder="请输入人员名称">
                            </div>
                        </div>
                        <div class="col-md-4 seachInputBox" style="width: 24.333333%;">
                            <div class="form-group">
                                ...
                                <input type="text" id="personCard" name="entity.personCard"
                                       value="${query.entity.personCard}" class="form-control" placeholder="请输入身份证号">
                            </div>
                        </div>
                        <div class="col-md-4 seachInputBox" style="width: 24.333333%;">
                            <div class="form-group">
                                ...
                                <input type="text" id="fugitiveNo" name="entity.fugitiveNo"
                                       value="${query.entity.fugitiveNo}" class="form-control" placeholder="请输入逃犯编号">
                            </div>
                        </div>
                        <div class="col-md-4 seachInputBox" style="width: 24.333333%;">
                            <div class="form-group">
                                ...
                                <input type="text" id="involvedNo" name="entity.involvedNo"
                                       value="${query.entity.involvedNo}" class="form-control" placeholder="请输入涉案编号">
                            </div>
                        </div>
                        <div class="col-md-4 seachInputBox" style="width: 24.333333%;">
                            <div class="form-group">
                                ...
                                <input type="text" id="involvedName" name="entity.involvedName"
                                       value="${query.entity.involvedName}" class="form-control" placeholder="请输入涉案名称">
                            </div>
                        </div>
                        <div class="col-md-4 seachInputBox" style="width: 24.333333%;">
                            <div class="form-group">
                                <label>在逃人员亲属姓名</label>
                                <input type="text" id="involvedParentName" name="involvedParentName"
                                       value="${query.involvedParentName}" class="form-control"
                                       placeholder="请输入在逃人员亲属姓名">
                            </div>
                        </div>
                        <div class="col-md-4 seachInputBox" style="width: 24.333333%;">
                            <div class="form-group">
                                <label>在逃人员亲属证件号</label>
                                <input type="text" id="involvedParentCard" name="involvedParentCard"
                                       value="${query.involvedParentCard}" class="form-control"
                                       placeholder="请输入在逃人员亲属证件号">
                            </div>
                        </div>
                        <div class="col-md-4 seachInputBox" style="width: 24.333333%;">
                            <div class="form-group">
                                ...
                                <input type="text" id="createDateTime" name="createDateTime"
                                       ...
                                       value="<fmt:formatDate value='${query.createDateTime}' pattern='yyyy-MM-dd'/>"
                                       placeholder="请选择录入时间"
                                       readonly="readonly">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 seachInputBox">
                            <div class="form-group">
                                ...
                                <button class="btn btn-blue btndown" type="button"><a
                                        href="<%=path%>/fugitivesTemplate">下载导入在逃人员模板</a></button>
                            </div>
                        </div>
                </form>
            </div>
...
<script>
    $(function () {
        ...
        kkpager.generPageHtml({
            ...
            //链接前部
            hrefFormer: '<%=path%>/fugitives/fugitivesRegManage',
            //链接尾部
            //hrefLatter: '.html',
        ...
        $("#repeatConfirmBtn").on("click", function(){
            location.href = "<%=path%>/fugitives/fugitivesRegManage";
        })
        ...
        function upload() {
            $.ajaxFileUpload({
                cache:false,
                url:"<%=path%>/fugitives/uploadFugitives",
                secureuri:false,
       ...
       //全局变量标识
        ...
        $(".addAuthenticator").click(function () {
            ...
            if (form.data('bootstrapValidator').isValid()) {
                ...
                $.ajax({
                    url : "<%=path%>/fugitives/operateFugitives",
                    type:"post",
        ...
        $("button[name='delBtn']", "#listTbody").on("click", function () {
            ...
            if (res == true) {
                ...
                $.ajax({
                    url: "<%=path%>/fugitives/delFugitivesInfo",
                    type: "post",
                    data: {
                        id: id
                    },

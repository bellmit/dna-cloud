                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>提取时间</label>
                                <input type="text" class="form-control form_datetime" id="extract2Time" placeholder="请输入提取时间"
                    ...
                    <div class="row inputBox">
                        <div class="col-md-4 small-left">
                            <div class="form-group">
                                ...
                                <%--<select class="form-control" name="delegateOrgCode" id="delegateOrgCode">--%>
                                <%--<option value="">请选择委托单位</option>--%>
                                <%--<c:forEach items="${orgInfoList2}" var="list" varStatus="s">--%>
                                <%--<option value="${list.orgCode}"--%>
                    ...
                    <div class="row inputBox">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                <label>案发时间</label>
                                <i class="required">*</i>
                                <input type="text" name="caseDatetime" id="caseDatetime" readonly
...
<script>
    $(function () {
        ...
        $("#delegateOrgCode").change(function () {
            $("#areaOrgCode").val($(this).val())
        })
        ...
        var url = "<%=path%>/center/submitNonDelegate";
                ...
                success: function (data) {
                    if (data.success || data.success == true || data.success == "true") {
                        ...
                        /*console.log(data.caseId)
                         ...
                         location.href = '
                        <%=path%>/caseQuery/updateCaseWord?caseId=' + data.caseId + '&consignmentId=' + data.consignmentId;*/

...
<head>
    ...
    <style>
        ...
        .bgTR tr:nth-last-child(2) td, .bgTR tr:last-child td{
            color: #e28005;
            font-size: 16px;
            font-weight: 600;
            background: #fff;
...
<%--<div class="row btn-box">--%>
    <%--<div class="col-md-12">--%>
        <%--<a href="javascript:history.go(-1);"><button type="button" class="btn btn-blue-border btn-lang" name="return">返回</button></a>--%>
    <%--</div>--%>
<%--</div>--%>

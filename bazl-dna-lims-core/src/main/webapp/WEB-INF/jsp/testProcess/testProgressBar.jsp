...
<head>
    ...
    <style>
        ...
        .technologicalProcess .col-md-3:nth-child(n+1):nth-child(-n+2) .ongoing + div:after {
            color: #00b39b
        }

        .technologicalProcess .col-md-3:nth-child(n+1):nth-child(-n+2) .complete + div:after {
            color: #00b39b
        }

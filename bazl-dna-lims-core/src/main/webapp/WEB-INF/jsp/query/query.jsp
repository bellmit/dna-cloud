    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form id="consignationForm" action="<%=path %>/center/query" class="form-horizontal tasi-form"
                      method="post">
                    <div class="row">
                        ...
                        <tr>
                            ...
                            <td  title="${list.entity.caseName}">
                                <c:if test="${fn:length(list.entity.caseName) gt 13}">
                                    ${fn:substring(list.entity.caseName,0,12)} ...
                                </c:if>
                                <c:if test="${fn:length(list.entity.caseName) lt 14}">
                                    ${list.entity.caseName}
                                </c:if>
                            </td>
                            ...
                            <td>
                                <c:choose>
                                    <c:when test="${list.status eq '01'}">未受理</c:when>
                                    <c:when test="${list.status eq '02'}">在检验</c:when>
                                    <c:when test="${list.status eq '03'}">已完成</c:when>
                                    <c:when test="${list.status eq '04'}">已退案</c:when>
                                </c:choose>
                            </td>

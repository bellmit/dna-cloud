...
$('.addMaterialEvidencerlSample').click(function () {
    ...
    extractMethodBox.find("select").val(extractMethod)
    sampleCarrierBox.find("select").val(sampleCarrier)
    console.log(extractMethod)
    console.log(sampleCarrier)
...
function getCaseInfoDna() {
    ...
    //caseInfoDna.caseXkNo = $("button[data-target='#siteSurveyBox']").prev().text();//现堪编号
    caseInfoDna.caseXkNo = $("#content").text();
    console.log(caseInfoDna.caseXkNo);
        ...
        form.bootstrapValidator({
            ...
            fields: {
                ...
                delegator2PhoneNumber: {
                    validators: {
                        regexp: {
                            regexp: /^(13[0-9]|14[5-9]|15[012356789]|166|17[0-8]|18[0-9]|19[8-9])[0-9]{8}$/,
                            message: '电话格式有误'
                        }
                    }
                },

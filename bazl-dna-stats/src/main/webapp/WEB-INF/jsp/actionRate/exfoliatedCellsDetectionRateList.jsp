    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form id="consignationForm" action="<%=path%>/actionRate/exfoliatedCellsDetectionRateList"
            ...
            <div class="panel-body" style="padding: 15px 0;">
                <div class="row">
                    <div class="col-md-8 sec-title">
                        <div class="title-tab active" name="detectionRateBtn">
                            侵财类案件脱落细胞检出率
                        </div>
                        <div class="title-tab " name="wzWarehousingRateBtn">
                            侵财类案件现场物证入库率
                        </div>
                    </div>
                    <div class="col-md-10 col-md-offset-10 export" name="exfoliatedCellsExportBtn">
                ...
                <table class="table table-hover table-bordered bigTable table-striped"
                    ...
                    <c:forEach items="${dbIvDetectionRateViewList}" var="ivDetectionRate" varStatus="s">
                        <tr>
                            <td>${ivDetectionRate.delegateOrgName}</td>
                            <td>${ivDetectionRate.comparisonCount}</td>
                            <td>${ivDetectionRate.notComparisonRkCount}</td>
                            <td>${ivDetectionRate.sampleCount}</td>
                            <td>${ivDetectionRate.computedResult}</td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
...
<script>
    $(function () {
        ...
        $("div[name='wzWarehousingRateBtn']").on("click", function () {
            var newUrl = "<%=path%>/actionRate/wzWarehousingRateList";
        ...
        $("div[name='exfoliatedCellsExportBtn']").click(function () {
            var newUrl = "<%=path%>/actionRate/exfoliatedCellsExpotr";
            $("#consignationForm").attr('action', newUrl);
            $("#consignationForm").submit();

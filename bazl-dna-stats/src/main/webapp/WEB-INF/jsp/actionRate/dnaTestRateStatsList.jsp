    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form id="consignationForm" action="<%=path%>/actionRate/dnaTestRateStatsList"
            ...
            <div class="panel-body" style="padding: 15px 0;">
                <div class="row">
                    <div class="col-md-8 sec-title">
                        <div class="title-tab " name="dnaActionRateBtn">
                            侵财类案件DNA综合作用率
                        </div>
                        <div class="title-tab active" name="dnaTestRateStatsBtn">
                            侵财类案件DNA检验率
                        </div>
                    </div>
                    <div class="col-md-10 col-md-offset-10 export" name="dnaTestRateExpotrBtn">
                ...
                <table class="table table-hover table-bordered bigTable table-striped"
                    ...
                    <c:forEach items="${dbIvDnaTestRateViewList}" var="dnaTestRate" varStatus="s">
                        <tr>
                            <td>${dnaTestRate.delegateOrgName}</td>
                            <td>${dnaTestRate.sjCaseCount}</td>
                            <td>${dnaTestRate.rkCaseCount}</td>
                            <td>${dnaTestRate.computedResult}</td>
                        </tr>
                    </c:forEach>
                    </tbody>
                </table>
...
<script>
    $(function () {
        ...
        $("div[name='dnaTestRateExpotrBtn']").click(function () {
            var newUrl = "<%=path%>/actionRate/dnaTestRateExport";
            $("#consignationForm").attr('action', newUrl);
            $("#consignationForm").submit();

            var oldUrl = "<%=path%>/actionRate/dnaTestRateStatsList";

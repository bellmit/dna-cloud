    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form id="consignationForm" action="<%=path%>/inspection/sampleInspectionStatsList" class="form-horizontal tasi-form form-inline"
                      method="post">
                    <div class="row">
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body" style="padding: 0 0 15px 0;">
                <table id="table-con" class="table table-hover table-bordered bigTable table-striped" style="table-layout: fixed;margin-top: 0;">
                    ...
                    <tr <%--title="total"--%>>
                        <td>总计</td>
                        <c:forEach items="${sampleTypeCountVoList}" var="total" varStatus="c">
                            <td title="${total.zjTotal}">${total.zjTotal}</td>
                            <td title="${total.ggTotal}">${total.ggTotal}</td>
                            <td title="${total.zzTotal}">${total.zzTotal}</td>
                            <td title="${total.xyTotal}">${total.xyTotal}</td>
                            <td title="${total.qtTotal}">${total.qtTotal}</td>
                            <td title="${total.tlxbTotal}">${total.tlxbTotal}</td>
                            <td title="${total.jbTotal}">${total.jbTotal}</td>
                            <td title="${total.mfTotal}">${total.mfTotal}</td>
                            <td title="${total.ycTotal}">${total.ycTotal}</td>
                            <td title="${total.tybTotal}">${total.tybTotal}</td>
                        </c:forEach>
                    </tr>
                    </tbody>
                </table>

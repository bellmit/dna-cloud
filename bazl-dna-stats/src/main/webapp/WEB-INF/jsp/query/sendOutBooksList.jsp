    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form id="consignationForm" action="<%=path%>/query/sendOutBooksList" class="form-horizontal tasi-form form-inline"
                      method="post">
                    <div class="row">
                        <div class="col-md-3" style="padding: 0;">
                            <div class="form-group">
                                ...
                                <select class="form-control" name="delegateOrg">
                                    ...
                                    <c:forEach items="${delagateOrgList}" var="delagateOrg" varStatus="cs">
                                        <option value="${delagateOrg.delegateOrg}"
                                                <c:if test="${delagateOrg.delegateOrg eq query.delegateOrg}">selected</c:if> >${delagateOrg.delegateOrgName}</option>
                                    </c:forEach>
                                </select>
                            </div>
                        </div>
...
<script>
    $(function () {
        ...
        $("div[name='comprehensiveQueryexportBtn']").click(function () {
            var newUrl = "<%=path%>/query/exportSendOutBooks";
            $("#consignationForm").attr('action',newUrl);
            $("#consignationForm").submit();

            var oldUrl = "<%=path%>/query/sendOutBooksList";

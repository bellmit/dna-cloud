...
<head>
    ...
    <style>
        ...
        .loginBox {
            width: 537px;
            height: 630px;
            background-color: RGBA(1, 14, 39, .5);
        ...
        .col-md-12:nth-child(12) {
            margin-top: 16px;
            color: #d3a814
        }

        .col-md-12:nth-child(12) a {
            color: #d3a814
        }

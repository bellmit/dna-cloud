        ...
        <form id="caseXkNoForm">
            <div class="modal-content">
                ...
                <div class="modal-footer clearfix">
                    <button class="btn btn-lang pull-left btn-blue modifySiteSurve" type="button">确认</button>
    ...
    <div class="row Modular">
        ...
        <div class="col-md-5 starBox">
            <p class="starP" style="margin-left: 70px">
                <i class="fa fa-star star" aria-hidden="true"></i>现勘编号:<span id="content">${xkNo}</span>

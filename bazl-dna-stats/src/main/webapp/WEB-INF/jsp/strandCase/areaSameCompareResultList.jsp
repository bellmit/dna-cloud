    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form id="consignationForm" action="<%=path %>/strandCase/strandCaseStatsList"
...
<script>
    $(function () {
        ...
        kkpager.generPageHtml({
            ...
            //链接前部
            hrefFormer: '<%=path%>/strandCase/strandCaseStatsList',
            //链接尾部
            //hrefLatter: '.html',
        ...
        $("button[name='reset']").on("click", function () {
            location.href = "<%=path%>/strandCase/strandCaseStatsList";
        })

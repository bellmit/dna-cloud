    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <form id="consignationForm" action="<%=path %>/queryCompareResult/queryAreaSameCompareResultDetail" class="form-horizontal tasi-form"
                      method="post">
                    <div class="row">
...
<script>
    $(function () {
        ...
        $("button[name='queryCompareCondition']").on("click", function () {
            ...
            location.href = "<%=path%>/strandCase/queryAreaSameCompareCondition?entity.compareStatus="
        ...
        kkpager.generPageHtml({
            ...
            //链接前部
            hrefFormer: '<%=path%>/strandCase/querySameAreaSameCompareResultDetail',
            //链接尾部
            //hrefLatter: '.html',
        ...
        $("button[name='reset']").on("click", function () {
            ...
            location.href = "<%=path%>/strandCase/querySameAreaSameCompareResultDetail?sampleNo=" +

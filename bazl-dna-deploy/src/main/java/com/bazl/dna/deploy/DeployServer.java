...
public class DeployServer {
	...
	public static void main(String[] args) {
		...
		// 部署目录
		String isDeploy = properties.getProperty("servers.deploy");
		if (Boolean.parseBoolean(isDeploy)) {
		...
		DeployMethod.deployServer(deployServerList, projectNames, properties.getProperty("deploy.name"),
				properties.getProperty("servers.name"), properties.getProperty("deploy.version"), properties.getProperty("deploy.suffix"));
	}

package com.bazl.dna.database.transfer.utils;
...
public class TransferSpecialMarkerUtil {
    ...
    public static Map<String, Object> analysisGene(String geneInfo) {
        ...
        for (Map.Entry<String, String> srcEntry : result.entrySet()) {
            map.put(transgerSpecialMarker(srcEntry.getKey()), srcEntry.getValue());
        }

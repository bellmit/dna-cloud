package com.bazl.dna.database.transfer.constants;
...
public class TransferConstants implements Serializable {
     ...
     * 刑事案件类别
     */
    public static final String CASE_TYPE_CRIMINAL = "01";
    /**
     * 民事案件类别
     */
    public static final String CASE_TYPE_CIVIL = "02";
    ...
    public static final String CASE_PROPERTY_NEW_PAQIE = "31";
    public static final String CASE_PROPERTY_NEW_DAOQIE = "100";
    public static final String CASE_PROPERTY_NEW_HUAPIANKAISUO = "131";
    public static final String CASE_PROPERTY_NEW_GAOKONGZHUIWU = "192";
    public static final String CASE_PROPERTY_NEW_DAOQIEDIANLAN = "312";
     ...
     * 入库样本类型
     */
    public static final String INSTORE_SAMPLE_TYPE_EVIDENCE = "01";
    public static final String INSTORE_SAMPLE_TYPE_MIX_EVIDENCE = "02";
    public static final String INSTORE_SAMPLE_TYPE_OFFENDER = "03";
    public static final String INSTORE_SAMPLE_TYPE_SUSPECT = "04";
    public static final String INSTORE_SAMPLE_TYPE_VICTIM = "05";
    public static final String INSTORE_SAMPLE_TYPE_MISSING = "06";
    public static final String INSTORE_SAMPLE_TYPE_UNKNOWN = "07";
    public static final String INSTORE_SAMPLE_TYPE_SUSPECT_RELATIVE = "08";
    public static final String INSTORE_SAMPLE_TYPE_VICTIM_RELATIVE = "09";
    public static final String INSTORE_SAMPLE_TYPE_MISSING_RELATIVE = "10";
    public static final String INSTORE_SAMPLE_TYPE_BASE = "11";
    public static final String INSTORE_SAMPLE_TYPE_YSTR = "12";
    public static final String INSTORE_SAMPLE_TYPE_UNIDENTIFIED = "13";


    /**
     * 鉴定要求
     */
    public static final String IDENTIFY_REQUIRED_SAME = "1";
    public static final String IDENTIFY_REQUIRED_RELATIVE = "2";
     ...
     */
    //血斑
    public static final String SAMPLE_TYPE_BLOOD = "01";
    //精斑
    public static final String SAMPLE_TYPE_SPERM = "02";
    //毛发
    public static final String SAMPLE_TYPE_HAIR = "03";
    //指甲
    public static final String SAMPLE_TYPE_NAIL = "04";
    //烟蒂
    public static final String SAMPLE_TYPE_CIGARETTE_END = "05";
    //唾液斑
    public static final String SAMPLE_TYPE_SALIVA = "06";
    //骨骼、牙齿
    public static final String SAMPLE_TYPE_SKELETON_TOOTH = "07";
    //肌肉(组织)
    public static final String SAMPLE_TYPE_MUSCLE_TISSUE = "08";
    //组织
    public static final String SAMPLE_TYPE_TISSUE = "09";
    //指纹
    public static final String SAMPLE_TYPE_FINGERPRINT = "10";
    //脱落细胞
    public static final String SAMPLE_TYPE_EXFOLIATED_CELLS = "11";
    //其它
    public static final String SAMPLE_TYPE_OTHER = "99";
     ...
     * 国家库样本类别：嫌疑父亲
     */
    public static final String NATION_SAMPLE_CATEGORY_SUSPECTED_FATHER = "020103";
     ...
     * 国家库样本类别：失踪嫌疑人
     */
    public static final String NATION_SAMPLE_CATEGORY_MISSING_SUSPECT = "020204";

    /**
     * 国家库样本类别：嫌疑人亲属、受害人亲属、失踪人口亲属  案件其他人员
     */
     ...
     * 国家库样本类别：强奸致孕受害人
     */
    public static final String NATION_SAMPLE_CATEGORY_RAPE_PREGNANCY_VICTIM = "020206";

    //身份不明人员委托
    /**
     * 国家库样本类别：未知名尸体
     */
    public static final String NATION_SAMPLE_CATEGORY_UNKNOWN_BODY = "010401";

    /**
     * 国家库样本类别：灾难死者
     */
    public static final String NATION_SAMPLE_CATEGORY_DISASTER_DEAD = "010403";

    /**
     * 国家库样本类别：其他身份不明人员
     */
    public static final String NATION_SAMPLE_CATEGORY_OTHER_UNIDENTIFIED_PERSONS = "010404";

    //灾难委托
    /**
     * 国家库样本类别：疑似灾难失踪人员
     */
    public static final String NATION_SAMPLE_CATEGORY_SUSPECTED_DISASTER = "010303";

    //失踪人口委托
    /**
     * 国家库样本类别：疑似被侵害失踪人员
     */
    public static final String NATION_SAMPLE_CATEGORY_SUSPECTED_INFRINGE = "010301";
    /**
     * 国家库样本类别：失踪儿童
     */
    public static final String NATION_SAMPLE_CATEGORY_MISSING_CHILD = "010302";
    /**
     * 国家库样本类别：负案在逃人员
     */
    public static final String NATION_SAMPLE_CATEGORY_FUGITIVES = "010304";
    /**
     * 国家库样本类别：疑似走失人员
     */
    public static final String NATION_SAMPLE_CATEGORY_SUSPECTED_MISSING = "010305";
    /**
     * 国家库样本类别：其他失踪人员/失踪人口
     */
     ...
     * 国家库样本类别：失踪儿童父亲
     */
    public static final String NATION_SAMPLE_CATEGORY_MISSING_FATHER = "010307";
    /**
     * 国家库样本类别：失踪儿童母亲
     */
    public static final String NATION_SAMPLE_CATEGORY_MISSING_MOTHER = "010308";
    /**
     * 国家库样本类别：失踪儿童采血申请人
     */
    public static final String NATION_SAMPLE_CATEGORY_MISSING_APPLICATION = "010309";
    /**
     * 国家库样本类别：失踪儿童用品
     */
    public static final String NATION_SAMPLE_CATEGORY_MISSING_SUPPLIES = "010310";
    /**
     * 国家库样本类别：失踪儿童同胞
     */
    public static final String NATION_SAMPLE_CATEGORY_MISSING_SIBLING = "010311";

    //建库委托
    /**
     * 国家库样本类别：前科人员
     */
    public static final String NATION_SAMPLE_CATEGORY_FORMER_STAFF = "010101";
    /**
     * 国家库样本类别：违法犯罪人员
     */
     ...
     * 国家库样本类别：个案排查人员
     */
    public static final String NATION_SAMPLE_CATEGORY_CASE_INVESTIGATOR = "010103";
    /**
     * 国家库样本类别：涉毒
     */
    public static final String NATION_SAMPLE_CATEGORY_DRUG_RELATED = "010104";
    /**
     * 国家库样本类别：卖淫
     */
    public static final String NATION_SAMPLE_CATEGORY_PROSTITUTION = "010106";
    /**
     * 国家库样本类别：嫖娼
     */
    public static final String NATION_SAMPLE_CATEGORY_WHORING = "010107";
    /**
     * 国家库样本类别：特殊职业者
     */
    public static final String NATION_SAMPLE_CATEGORY_SPECIAL_OCCUPATION = "010108";
    /**
     * 国家库样本类别：其他建库人员
     */
    public static final String NATION_SAMPLE_CATEGORY_OTHER_OFFENDER = "010109";
    /**
     * 国家库样本类别：家系人员
     */
    public static final String NATION_SAMPLE_CATEGORY_FAMILY_MEMBERS = "010110";
    ...
    /** 儿子 */
    public final static String RELATION_TYPE_07  = "07";
    /** 女儿 */
    public final static String RELATION_TYPE_08  = "08";
    /** 本人 */
    public final static String RELATION_TYPE_09  = "09";
    ...
    //本地库常规类型
    public final static String GENE_NORMAL = "1";
    //本地库混合类型
    public final static String GENE_MIXED = "3";
    //本地库Y基因型类型
    public final static String GENE_YSTR = "2";

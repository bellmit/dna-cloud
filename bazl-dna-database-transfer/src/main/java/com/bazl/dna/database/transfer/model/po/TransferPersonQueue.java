...
public class TransferPersonQueue implements Serializable {
    ...
    public String getTransferFileRootPath() {
        return transferFileRootPath;
    }

    public void setTransferFileRootPath(String transferFileRootPath) {
        this.transferFileRootPath = transferFileRootPath;
    }
    ...
    public String toString() {
        return "TransferPersonQueue{" +
                "id='" + id + '\'' +
                ", sampleBarcode='" + sampleBarcode + '\'' +
                ", caseId='" + caseId + '\'' +
                ", transferStatus=" + transferStatus +
                ", transferFileName='" + transferFileName + '\'' +
                ", transferFileRootPath='" + transferFileRootPath + '\'' +
                ", failedMsg='" + failedMsg + '\'' +

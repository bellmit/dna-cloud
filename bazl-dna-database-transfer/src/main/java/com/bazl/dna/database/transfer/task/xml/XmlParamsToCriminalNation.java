package com.bazl.dna.database.transfer.task.xml;
...
public class XmlParamsToCriminalNation {
    ...
    public String getXmlCaseInfoModel(CaseInfoModel caseInfoModel) {
        ...
        if(caseInfoModel != null) {
            ...
            str.append("<occurrenceDatetime>").append(caseInfoModel.getOccurrenceDate() == null ? "无" : DateUtils.dateToString(caseInfoModel.getOccurrenceDate(),"yyyyMMddHHmmss")).append("</occurrenceDatetime>");

 ...
 */
@Component
public interface IQuickCompareRelativeThreeConjoinedService {
	...
	@RabbitListener(
		...
		bindings = @QueueBinding(
				value = @Queue(value = QuickCompareConstants.QUEUE_NAME_QUICK_RELATIVE_THREE_CONJOINED, autoDelete = "false"), 
				exchange = @Exchange(value = QuickCompareConstants.QUEUE_TYPE_QUICK_RELATIVE_THREE_CONJOINED, type = ExchangeTypes.DIRECT), 
				key = QuickCompareConstants.QUEUE_KEY_QUICK_RELATIVE_THREE_CONJOINED_COMPARE
		)
	)

 ...
 */
@Component
public interface IQuickCompareStrService {
	...
	@RabbitListener(
		...
		bindings = @QueueBinding(
				value = @Queue(value = QuickCompareConstants.QUEUE_NAME_QUICK_STR, autoDelete = "false"), 
				exchange = @Exchange(value = QuickCompareConstants.QUEUE_TYPE_QUICK_STR, type = ExchangeTypes.DIRECT), 
				key = QuickCompareConstants.QUEUE_KEY_QUICK_STR_COMPARE
		)
	)

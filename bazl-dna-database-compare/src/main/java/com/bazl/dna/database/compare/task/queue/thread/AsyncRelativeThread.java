...
@Component
public class AsyncRelativeThread {
	
	private static final Logger LOG = LoggerFactory.getLogger(AsyncRelativeThread.class);
    ...
    public void executeAsyncTask(int pageIndex, int pageSize) {
		...
		for (Map<String, Object> map : list) {
			...
			queue.setCompareMode(Constants.COMPARE_MODE_RELATIVE_THREE_CONJOINED);

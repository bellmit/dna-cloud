...
@Component
public class AsyncYstrThread {
	
	private static final Logger LOG = LoggerFactory.getLogger(AsyncYstrThread.class);
    ...
    public void executeAsyncTask(int pageIndex, int pageSize) {
		...
		for (Map<String, Object> map : list) {
			...
			queue.setCompareMode(Constants.COMPARE_MODE_YSTR);

 ...
 */
@Component
public interface IQuickCompareMixService {
	...
	@RabbitListener(
		...
		bindings = @QueueBinding(
				value = @Queue(value = QuickCompareConstants.QUEUE_NAME_QUICK_MIX, autoDelete = "false"), 
				exchange = @Exchange(value = QuickCompareConstants.QUEUE_TYPE_QUICK_MIX, type = ExchangeTypes.DIRECT), 
				key = QuickCompareConstants.QUEUE_KEY_QUICK_MIX_COMPARE
		)
	)

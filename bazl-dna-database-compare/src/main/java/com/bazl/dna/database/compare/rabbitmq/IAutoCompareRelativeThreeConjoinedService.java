 ...
 */
@Component
public interface IAutoCompareRelativeThreeConjoinedService {
	...
	@RabbitListener(
		...
		bindings = @QueueBinding(
				value = @Queue(value = AutoCompareConstants.QUEUE_NAME_AUTO_RELATIVE_THREE_CONJOINED, autoDelete = "false"), 
				exchange = @Exchange(value = AutoCompareConstants.QUEUE_TYPE_AUTO_RELATIVE_THREE_CONJOINED, type = ExchangeTypes.DIRECT), 
				key = AutoCompareConstants.QUEUE_KEY_AUTO_RELATIVE_THREE_CONJOINED_COMPARE
		)
	)

...
import com.bazl.dna.database.compare.task.queue.thread.AsyncStrThread;
import com.bazl.dna.database.service.service.DnaStrGeneInfoService;

@Component
public class CompareQueueStrTask {
	
	private static final Logger LOG = LoggerFactory.getLogger(CompareQueueStrTask.class);
	
	@Autowired
	private DnaStrGeneInfoService geneInfoService;
	
	@Autowired
	private AsyncStrThread asyncTask;

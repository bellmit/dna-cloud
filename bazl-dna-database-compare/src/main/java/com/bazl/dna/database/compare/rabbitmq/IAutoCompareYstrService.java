 ...
 */
@Component
public interface IAutoCompareYstrService {
	...
	@RabbitListener(
		...
		bindings = @QueueBinding(
				value = @Queue(value = AutoCompareConstants.QUEUE_NAME_AUTO_YSTR, autoDelete = "false"), 
				exchange = @Exchange(value = AutoCompareConstants.QUEUE_TYPE_AUTO_YSTR, type = ExchangeTypes.DIRECT), 
				key = AutoCompareConstants.QUEUE_KEY_AUTO_YSTR_COMPARE
		)
	)
